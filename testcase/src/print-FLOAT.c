...
int main() {
    ...
    printf(buf,"%f %d", FLOAT_ARG(0xfffecccd), 123456);

#else
	//sprintf(buf, "%f %f", FLOAT_ARG(0x00010000),FLOAT_ARG(0x00013333));
//	nemu_assert(strcmp(buf, "1.000000 1.199996") == 0);
	
//	sprintf(buf, "%d %f", 123,FLOAT_ARG(0xfffecccd));
//	nemu_assert(strcmp(buf, "123 -1.199996") == 0);
...
//	nemu_assert(strcmp(buf, "1.199996") == 0);
	...
	sprintf(buf, "%f %d", FLOAT_ARG(0x10000), 123456);
	nemu_assert(strcmp(buf, "1.000000 123456") == 0);
#endif
